#
# Table structure for table 'tx_t3gtd_domain_model_usermessage'
#
CREATE TABLE tx_t3gtd_domain_model_usermessage (
...
#
# Table structure for table 'tx_t3gtd_domain_model_context'
#
CREATE TABLE tx_t3gtd_domain_model_context (
...
#
# Table structure for table 'tx_t3gtd_domain_model_project'
#
CREATE TABLE tx_t3gtd_domain_model_project (
...
#
# Table structure for table 'tx_t3gtd_domain_model_task'
#
CREATE TABLE tx_t3gtd_domain_model_task (
	...
	task_state int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_t3gtd_domain_model_userconfig'
#
CREATE TABLE tx_t3gtd_domain_model_userconfig (
